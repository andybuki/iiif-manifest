...
public class NoteIdentifier {
    ...
    public static Metadata get(CollectionAttributes turfanAttributes, Manifest manifest) {
        ...
        if(turfanAttributes.getNoteIdentifier()!=null) {
            metadata = new Metadata(new Label( "de","turfan:noteIdentifier"),
                    new Value( new I18n("de", turfanAttributes.getNoteIdentifier())));
            return metadata;
        }
        else {
            return metadata;
