...
public enum CollectionConfig {
    ...
    TAP(
            ...
            "TAP Collection",
            "The \"Photography Database of the National Taipei University of Education\" presents over 2,900 photographs of the The National Taipei University of Education 國立臺北教育大學 (NTUE). Covering the 1920s to the 1990s, the collection illustrates pedagogic training, student and teacher extracurricular activities. (rights: CC-BY-NC-SA)",
            "Images are made available by the National Taipei University of Education 國立臺北教育大學 (NTUE) und the copyright CC-BY-NC-SA. Metadata were produced by a Taiwan-German research team based at National Taiwan Normal University (Taipei), National Cheng Kung University (Tainan), and Ruhr University Bochum. The project is financed by the Chiang Ching-kuo Foundation for International Scholarly Exchange.",
            "https://iiif-content.crossasia.org/xasia/",
