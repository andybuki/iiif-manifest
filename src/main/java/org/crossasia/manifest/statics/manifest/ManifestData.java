...
public class ManifestData {
    ...
    public static final String MANIFEST_COLLECTION="xinjiang-legaldocuments+";
    ...
    public static final String MANIFEST_REQUIRED_STATEMENT = "Images and metadata are made available by the National Library of Laos (CC BY-NC 4.0) via the Staatsbibliothek zu Berlin | CrossAsia";
