...
import org.crossasia.manifest.metadata.StaticFieldsDllmtCollection;
...
public class IIIFPresentationDlmntPhoto {
    ...
    private static final String MANIFEST_COLLECTION="dlntm+images+";
    public static final String COLLECTION_PATH = "dlntm/images";
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i=0; i<photosObject.length(); i++) {
            ...
            File created = new File("/data/dlmnt/photos/final/");
            ...
            if (jsonObj.has("position")) {
                ...
                try {
                    URL url = new URL("https://iiif-content.crossasia.org/xasia/dlntm+images+" + "" + book_ID + "/info.json");
